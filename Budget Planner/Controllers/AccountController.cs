...
namespace Budget_Planner.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [AllowAnonymous]
        public async Task<ActionResult> LoginDemo(string demoRole, string returnUrl)
        {
            var email = "";
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var household = new Household { Name = model.HouseholdName };
        ...
        [HttpGet]
        [AllowAnonymous]
        public ActionResult Register_Join(int invitationHouseholdId, int invitationId, Guid inviteCode)
        {
            ...
            Household HouseholdToJoin = db.Households.FirstOrDefault(h => h.Id == invitationHouseholdId);

            RegisterViewModel registerViewModel = new RegisterViewModel();
            registerViewModel.HouseholdName = HouseholdToJoin.Name;
            registerViewModel.HouseholdId = HouseholdToJoin.Id;
            registerViewModel.Email = invitation.Email;
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Register_Join(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
